...
# experiment 1 keeps a constant red light at the highest intensity
...
try:
    with open("/experiment1.csv", "a") as ex:
        while True:
            curr_dt = r.datetime
            ...
            while curr_moist < MOISTURE_LEVEL:
                is_water = True
            ...
            ex.write("{day}, {t}, {temp}, {b_moist}, {is_water}, {a_moist}\n".format(
